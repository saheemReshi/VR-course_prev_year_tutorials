# File: /image-processing-project/image-processing-project/PartH/task1_solution.py
...
def extract_texture_features(co_matrix):
    ...
    features['entropy'] = -np.sum(co_matrix[co_matrix > 0] * np.log(co_matrix[co_matrix > 0]))
